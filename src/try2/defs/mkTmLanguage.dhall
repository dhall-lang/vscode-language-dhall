let mkTmLanguage = λ (Grammar: Type) -> λ (Pattern: Type) ->  { `$schema` : Optional Text
, name : Optional Text 
...
--- from Grammar:
, patterns :  List Pattern  -- FIXME: List Patterns, default []
, repository: List { mapKey : Text, mapValue: Grammar } -- FIXME: reference on grammar
} 
