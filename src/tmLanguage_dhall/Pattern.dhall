{
    ...
    , name: Optional String -- ! FIXME: it's not a string, but NAME
    ...
    , captures : String -- FIXME: object with recursive values name - pattern
    ...
    , patterns: [./Pattern] Self ref again
    , applyEndPatternLast: Integer -- 0/1
    , while: String
